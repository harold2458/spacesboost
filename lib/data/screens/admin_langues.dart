...
class AdminLangues extends StatefulWidget {
  const AdminLangues({super.key});

  @override
  State<AdminLangues> createState() => _AdminLanguesState();
}

class _AdminLanguesState extends State<AdminLangues> {
