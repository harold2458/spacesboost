            ...
            GestureDetector(
              ...
              child: Container(
                  ...
                  child: Column(
                      children: [
                        !_imagesLoaded ?
                        const CircularProgressIndicator(color: Color(0XFFFCBC1C),) : Image.asset('assets/images/annonce.jpg', width: screenWidth * (isPortrait ? 0.8 : 0.7),),
                        SizedBox(height: screenHeight * (isPortrait ? 0.03 : 0.1),),
                        Row(
                          children: [
                            Text('🎯 Collaboration dans le Secteur de la Mode', style: TextStyle(
                        ...
                        Text("Nous sommes une marque de vêtements tendance et innovante, à la recherche d’un influenceur ..."
                          , style: TextStyle(
