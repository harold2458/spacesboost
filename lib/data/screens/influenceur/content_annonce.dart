...
class ContentAnnonce extends StatefulWidget {
  const ContentAnnonce({super.key});

  @override
  State<ContentAnnonce> createState() => _ContentAnnonceState();
}

class _ContentAnnonceState extends State<ContentAnnonce> {
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                const BeforeHome(initialIndex: 4)));
                  },
                  style: ButtonStyle(
                    backgroundColor:
