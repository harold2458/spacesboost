...
import 'package:projet_mobile/data/screens/influenceur/content_envoye.dart';

class PreuveEnvoyee extends StatefulWidget {
  const PreuveEnvoyee({super.key});

  @override
  State<PreuveEnvoyee> createState() => _PreuveEnvoyeeState();
}

class _PreuveEnvoyeeState extends State<PreuveEnvoyee> {
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const ContentEnvoye()),
                );
              },
              child: Container(
