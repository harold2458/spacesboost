...
class AdminEditProfil extends StatefulWidget {
  const AdminEditProfil({super.key});

  @override
  State<AdminEditProfil> createState() => _AdminEditProfilState();
}

class _AdminEditProfilState extends State<AdminEditProfil> {

  final _formKey = GlobalKey<FormState>();
  final TextEditingController _firstNameController = TextEditingController(text: 'SUPER');
  final TextEditingController _lastNameController = TextEditingController(text: 'Admin');
  final TextEditingController _emailController = TextEditingController(text: 'adminsuper@gmail.com');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: const Text('Modifier profil', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white),),
          centerTitle: true,
