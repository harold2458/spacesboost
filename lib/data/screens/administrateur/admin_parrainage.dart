...
class AdminParrainage extends StatefulWidget {
  const AdminParrainage({super.key});

  @override
  State<AdminParrainage> createState() => _AdminParrainageState();
}

class _AdminParrainageState extends State<AdminParrainage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: const Text('Parrainage', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white),),
          centerTitle: true,
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      icon: const Icon(Icons.copy, color: Color(0xfffcbc1c)),
