...
class AdminValidationUsers extends StatefulWidget {
  const AdminValidationUsers({super.key});

  @override
  State<AdminValidationUsers> createState() => _AdminValidationUsersState();
}

class _AdminValidationUsersState extends State<AdminValidationUsers> {
...
class UserDataSource extends DataTableSource {
  ...
  UserDataSource(this.users, this.context, this.notifyParent,
  ...
  void _showUserInfo(BuildContext context, Map<String, dynamic> user) {
    ...
    showDialog(
      ...
      builder: (context) =>
          AlertDialog(
            title: const Text('Détails de l\'utilisateur', style: TextStyle(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if(user["typeCompte"] == "Entreprise") ...[
                    ...
                    if(user['typeCompte'] == "Influenceur") ...[
                      RichText(
                          text: TextSpan(
                              children: [
                                TextSpan(
  ...
  List<Widget> _buildUserDetails(Map<String, dynamic> user) {
    ...
    if (user["typeCompte"] == "Entreprise") {
      ...
      details.add(
          Text('Réseaux: ${(user['reseaux'] as List<String>).join(", ")}'));
    }

    details.add(
      Text('Conditions acceptées: ${user['conditionsAcceptees']
          ? "Oui"
          : "Non"}'),
    );
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: DropdownButtonFormField<String>(
                                  ...
                                  items: selectedCountry == null
                                      ...
                                      : countryCities[selectedCountry]!.map((
                                      String city) {
                                    return DropdownMenuItem<String>(
                                      value: city,
                                      child: Text(city),
                              ...
                              if (selectedTypeAccount == "Influenceur") ...[
                                ...
                                SizedBox(height: screenHeight * (isPortrait
                                    ? 0.03
                                    : 0.1)),
                                SizedBox(
                                  width: screenWidth * (isPortrait ? 0.9 : 0.8),
                                ...
                                SizedBox(
                                  width: screenWidth * 0.8,
                                  height: screenHeight * (isPortrait
                                      ? 0.03
                                      : 0.1),
                                  child: Row(
                                    children: [
