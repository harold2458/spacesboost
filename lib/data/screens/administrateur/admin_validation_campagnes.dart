...
class AdminValidationCampagnes extends StatefulWidget {
  const AdminValidationCampagnes({super.key});

  @override
  State<AdminValidationCampagnes> createState() => _AdminValidationCampagnesState();
}

class _AdminValidationCampagnesState extends State<AdminValidationCampagnes> {
            ...
            SingleChildScrollView(
              ...
              child: SizedBox(
                ...
                child: PaginatedDataTable(
                  header: _buildHeader(
                      selectedTypeCampaign, screenWidth, isPortrait),
                  columns: [
                    const DataColumn(label: Text('N°', style: TextStyle(
                        fontWeight: FontWeight.bold, color: Color(
                        0xff072858)),)),
                    const DataColumn(label: Text('Titre', style: TextStyle(
                        fontWeight: FontWeight.bold, color: Color(
                        0xff072858)),)),
                    const DataColumn(label: Text('Contenu', style: TextStyle(
                        fontWeight: FontWeight.bold, color: Color(
                        0xff072858)),)),
                    const DataColumn(label: Text('Fichier', style: TextStyle(
                        fontWeight: FontWeight.bold, color: Color(
                        0xff072858)),)),
                    const DataColumn(label: Text('Type campagne',
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: Color(
                          0xff072858)),)),
                    ...
                    if(selectedTypeCampaign == "Annonce") ...[
                      ...
                      if(selectedTypeCampaign == "Promotion") ...[
                      ] else
                        if(selectedTypeCampaign == "Contenu") ...[
                        ],

                    const DataColumn(label: Text('Actions', style: TextStyle(
                        fontWeight: FontWeight.bold, color: Color(
                        0xff072858)),)),
                  ],
  ...
  Widget _buildHeader(String? selectedTypeCampaign, double screenWidth,
      bool isPortrait) {
    final color = _getIconColor(
        selectedTypeCampaign); // Obtenir la couleur dynamique
      ...
      builder: (context) {
        ...
        return StatefulBuilder(
            builder: (context, setState) {
              return AlertDialog(
                title: const Text('Ajout d\'un campagn', style: TextStyle(
                    fontWeight: FontWeight.bold, color: Color(0xff072858))),
                      ...
                      Row(
                        ...
                        children: [
                          IconButton(
                              ...
                              onPressed: pickFile,
                              icon: const Icon(
                                  Icons.attach_file, color: Color(0xff072858))
                          ),
                          const SizedBox(width: 15),
                          selectedFile != null
                              ? Text("Fichier: $selectedFile")
                              : const Text(
                            "Aucun fichier sélectionné", style: TextStyle(
                              fontSize: 14),),
                        ],
                      ),
                      SizedBox(
